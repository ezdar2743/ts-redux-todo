...
const Item = styled.li`
  margin-left: 20px;
`;
const NavText = styled.h3<{ isActive: boolean }>`
  font-size: 24px;
  color: ${(props) =>
    props.isActive ? props.theme.lineText : props.theme.onText};
`;
  ...
  return (
    <Navbar animate={scrollAnimation}>
      ...
      <NavItems>
        <Item>
          <Link to="/">
            <NavText isActive={toDoMatch !== null}>To Do</NavText>
          </Link>
        </Item>
        <Item>
          <Link to="/user">
            <NavText isActive={userMatch !== null}>User</NavText>
          </Link>
        </Item>
        <Item>
          <Link to="/shopping">
            <NavText isActive={shoppingMatch !== null}>Shopping</NavText>
          </Link>
        </Item>
      </NavItems>
